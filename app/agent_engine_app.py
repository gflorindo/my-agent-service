...
# Dynamically import the agent based on the AGENT_NAME environment variable
agent_name = os.environ.get("AGENT_NAME", "app")  # Default to "app"
try:
    agent_module = importlib.import_module(f"{agent_name}.agent")
    root_agent = agent_module.root_agent
except (ImportError, AttributeError):
    print(f"Could not import '{agent_name}.agent'. Defaulting to 'app.agent'.")
